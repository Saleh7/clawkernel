  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'src/app/chat/lib/input-history.ts',
        'src/app/chat/lib/json-detect.ts',
        'src/app/chat/lib/silent-filter.ts',
        'src/app/chat/lib/pinned-messages.ts',
        'src/app/chat/lib/deleted-messages.ts',
        'src/app/chat/lib/slash-commands.ts',
      ],
    },
  },
})
